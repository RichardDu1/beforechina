          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              },
              {
                ...
                content: `Enter the park at 7am — a 4-day pass can be purchased at the gate. Take the Bailong Elevator (百龙天梯) — a glass elevator built against a 326m cliff face, the world\'s tallest outdoor elevator. At the top, walk to Yuanjiajie Scenic Area (袁家界) — the Avatar Hallelujah Mountains viewpoint. The \'Southern Sky Pillar\' (南天一柱), renamed \'Avatar Hallelujah Mountain\' in 2010, is the pillar that inspired the film. Then shuttle bus to Tianzi Mountain (天子山) — panoramic views of the pillar forest from 1,262m. Descend by cable car.`,
              ...
              },
              {
                ...
                content: `Morning: Tianmen Mountain (天门山) — take the world\'s longest cable car (7.5 km, 30 minutes) from Zhangjiajie city centre to the summit at 1,430m. The cable car rises over the city, farmland, and then up the mountain face. At the top, walk the cliff-hanging walkway (玻璃栈道) — a 60m glass path bolted to a vertical cliff. Then walk to Tianmen Cave (天门洞) — a natural arch 131.5m high in the mountain, reached by the 999-step \'Stairway to Heaven\' or an escalator inside the mountain. Descend by bus on the 99-bend road (通天大道), one of the world\'s most dramatic roads. Afternoon: fly out or take the train.`,
