          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              },
              {
                ...
                content: `Take the 10-minute ferry from Xiamen to Gulangyu Island (鼓浪屿). Gulangyu is a car-free island of colonial villas, tropical gardens, and narrow lanes. It was a foreign concession from 1903-1945, and the architecture reflects this: British consulates, Japanese hospitals, Spanish cathedrals. Visit Shuzhuang Garden (菽庄花园) — a seaside garden with a piano museum housing 100 antique pianos. Climb Sunlight Rock (日光岩) for the island panorama. Evening: ferry back to Xiamen.`,
              ...
              },
              {
                ...
                content: `Take a 3-hour bus from Xiamen to Nanjing Tulou cluster. The Nanjing Tulou are the most scenic group. Visit Tianluokeng Tulou Cluster (田螺坑) — five tulou arranged in a pattern locals call \'four dishes and a soup\' (four round buildings around one square). Then Yuchang Lou (裕昌楼) — a 700-year-old tulou whose pillars lean at 15° (it is called the \'Leaning Tower of Pisa of Fujian\'). Finish at Taxia Village (塔下村) — a Hakka village along a stream with a unique stone flagpole forest honouring successful scholars. Stay overnight in a tulou guesthouse.`,
              ...
              },
              {
                ...
                content: `If your flight is in the evening: visit the Xiamen Botanical Garden or cycle the Huandao Road coastal path (bikes easily rented along the route). Buy oolong tea (Fujian is the home of Tieguanyin and Dahongpao) and dried seafood as souvenirs.`,
