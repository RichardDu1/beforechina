          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              },
              {
                ...
                content: `Gentle day exploring Lhasa. Morning: Barkhor Street (八廓街) — the 1 km pilgrim circuit around the Jokhang Temple, lined with shops selling prayer wheels, thangka paintings, and yak butter. Watch pilgrims prostrating their way around the circuit. Visit Jokhang Temple (大昭寺) — Tibet\'s holiest temple, housing a life-sized gilded statue of the 12-year-old Buddha (Jowo Rinpoche) brought to Tibet in 641 AD. Afternoon: Sera Monastery (色拉寺) for the famous monk debate (3-4pm daily except Sundays) — monks debate Buddhist philosophy in a courtyard with dramatic clapping gestures.`,
              ...
              },
              {
                ...
                content: `Sunrise at Everest Base Camp — the north face glows gold at dawn. Walk to the Base Camp marker (5,200m) for photos, then drive 7-8 hours back to Shigatse. The return drive retraces the route over the high passes. Stop at Sakya Monastery (萨迦寺) en route — a 13th-century monastery of the Sakya school, with massive grey walls and a library of 84,000 manuscripts. Arrive Shigatse in the evening.`,
