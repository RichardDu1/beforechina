          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              },
              {
                ...
                content: `Take the 1.5-hour high-speed train from Lanzhou West to Wuwei East. Wuwei (武威) was the first city the Silk Road reached after leaving the Chinese heartland. Visit the Leitai Han Tomb (雷台汉墓) where the Flying Horse of Gansu was discovered in 1969. The tomb is a brick-vaulted Han dynasty general\'s burial with 99 bronze chariots and horses. Afternoon: Confucius Temple (文庙), the largest in northwest China, and the Wuwei Museum for Silk Road artefacts. Evening: Wuwei \'three sets\' noodles (三套车) — noodles, braised pork, and tea.`,
              ...
              },
              {
                ...
                content: `Take the 1-hour high-speed train from Wuwei East to Zhangye West. Afternoon: Zhangye Danxia Landform — the rainbow mountains at their best in late afternoon light. Stay overnight in Zhangye.`,
              ...
              },
              {
                ...
                content: `Take the 1.5-hour high-speed train from Zhangye West to Jiayuguan South. Full afternoon at Jiayuguan Fortress, the Overhanging Great Wall, and the First Strategic Post — the western end of the Ming dynasty Great Wall. Evening: Jiayuguan lamb skewers.`,
              ...
              },
              {
                ...
                content: `Full morning at the Mogao Caves (book 2-4 weeks ahead). The guided tour (A-category) covers 8 caves including the Tang dynasty masterpieces. Afternoon: Dunhuang Museum and a rest. Evening: optional second visit to Mingsha Sand Dunes (the ticket is valid for 3 days).`,
