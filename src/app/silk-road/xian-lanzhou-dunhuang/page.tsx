          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              },
              {
                ...
                content: `Fly out from Dunhuang Mogao Airport (DNH). Direct flights to Xian (2.5 hrs), Lanzhou (1.5 hrs), and Beijing (4 hrs). If your flight is in the evening, visit the Western Thousand Buddha Caves (西千佛洞) — a smaller, less-visited cave complex 35 km west of Dunhuang with 16 surviving caves.`,
