            ...
            {[
              {
                ...
                content: `Start at Victoria Peak (太平山) — take the Peak Tram (¥45 one way, est. 1888) to the top for the classic Hong Kong skyline view. Walk the Peak Circle Walk (3.5 km, 1 hour) for 360° views. Descend to Central and walk the Mid-Levels Escalators — the world\'s longest outdoor covered escalator system (800m), past bars, galleries, and noodle shops. Lunch: dim sum at Tim Ho Wan (添好运, the world\'s cheapest Michelin-starred restaurant, ¥50/person). Afternoon: Man Mo Temple (文武庙, free), dedicated to the gods of literature and war, with giant incense coils hanging from the ceiling. Evening: Star Ferry across Victoria Harbour (¥3, 10 min, running since 1888) to Tsim Sha Tsui. Watch the Symphony of Lights (8pm) from the TST waterfront.`,
              ...
              },
              {
                ...
                content: `Morning: A-Ma Temple (妈阁庙, free) — Macau\'s oldest temple (1488), dedicated to the sea goddess Mazu (Macau\'s name comes from \'A-Ma Gau\' — \'Bay of A-Ma\'). Visit the Macau Tower (¥135) for the 360° view from 338m, or walk the Coloane Village — Macau\'s southernmost island with a fishing village atmosphere, pastel houses, and the original Lord Stow\'s Bakery. Afternoon: ferry back to Hong Kong (1 hr, ¥160). Fly out from Hong Kong International Airport (HKG).`,
