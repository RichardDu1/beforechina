          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              },
              {
                ...
                content: `Fly out from Sanya (SYX) or Haikou (HAK). Both airports have flights to major Chinese cities and international connections to Southeast Asia. If extending: Hainan has a 51km coastal road from Sanya to Lingshui — rent a car and drive it. The road passes through fishing villages, coconut groves, and viewpoints over the South China Sea. Or visit the Bo\'ao Forum site (博鳌, 1.5 hrs from Haikou) — the \'Davos of Asia\', a conference centre on a river estuary.`,
