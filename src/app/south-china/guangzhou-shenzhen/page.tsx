        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              {
                day: 'Day 1: Guangzhou',
                content: `Fly into Guangzhou Baiyun Airport (CAN). Afternoon: Chen Clan Academy (陈家祠) — an 1894 ancestral hall that is the finest surviving example of Lingnan architecture, with intricate ceramic friezes, wood carvings, and ivory sculptures on every surface. Walk Shamian Island (沙面) — a sandbank island that was the British-French concession, now a quiet neighbourhood of colonial buildings, banyan trees, and cafes. Evening: dinner at a traditional Cantonese restaurant — roast goose (烧鹅), white-cut chicken (白切鸡), and claypot rice (煲仔饭).`,
              ...
              },
              {
                ...
                content: `Morning: dim sum at Panxi Restaurant (泮溪酒家, est. 1947) or Dian Dou De (点都德, a popular chain with consistent quality). Cantonese dim sum is the original and best — har gow (shrimp dumplings), siu mai (pork dumplings), char siu bao (BBQ pork buns), and egg tarts. Afternoon: visit the Mausoleum of the Nanyue King (南越王墓) — a 2,000-year-old tomb of a regional king from the Nanyue kingdom (204-111 BC), with a jade burial suit sewn with silk thread. Then Guangdong Museum (free, book ahead). Evening: Pearl River night cruise for the Canton Tower light show.`,
              ...
              },
              {
                ...
                content: `Option A: Fly out from Shenzhen Bao\'an Airport (SZX) or Guangzhou (CAN). Option B: take the 15-minute high-speed train from Shenzhen North to Hong Kong West Kowloon and continue to Hong Kong (see the Hong Kong & Macau route).`,
