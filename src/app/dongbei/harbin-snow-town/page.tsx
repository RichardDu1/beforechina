          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              },
              {
                ...
                content: `Afternoon-evening: Harbin Ice and Snow World (哈尔滨冰雪大世界) — the main event. The park covers 600,000 m² and features buildings, castles, slides, and sculptures all made of ice blocks from the Songhua River. The ice is 50-80cm thick and crystal clear. Go at 3pm to see the sculptures in daylight (they are blue-white) and stay for the neon light show after dark (4:30pm in winter). The ice slides are terrifying and essential. The temperature inside the park is -25°C to -35°C — dress like you are going to the Arctic.`,
              ...
              },
              {
                ...
                content: `Fly out from Harbin. If your flight is in the evening, visit the Unit 731 Museum (free, 1.5 hrs from Harbin centre) — a Japanese biological warfare research facility from WWII, now a somber museum. It is heavy but historically important. Alternatively, visit the Harbin Polarland for beluga whale shows and penguins — lighter fare for a departure day.`,
