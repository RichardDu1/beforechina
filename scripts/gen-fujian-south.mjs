  ...
  // --- FUJIAN ---
  {
    ...
    stops: [
      ...
      },
      {
        ...
        content:
          'Take the 10-minute ferry from Xiamen to Gulangyu Island (鼓浪屿). Gulangyu is a car-free island of colonial villas, tropical gardens, and narrow lanes. It was a foreign concession from 1903-1945, and the architecture reflects this: British consulates, Japanese hospitals, Spanish cathedrals. Visit Shuzhuang Garden (菽庄花园) — a seaside garden with a piano museum housing 100 antique pianos. Climb Sunlight Rock (日光岩) for the island panorama. Evening: ferry back to Xiamen.',
        tip: 'Gulangyu ferry tickets sell out in summer and on weekends. Book on the official WeChat mini-program (厦门轮渡). The ferry from Dongdu Jetty (for tourists) has a modest fee; the ferry from Lundu Jetty is for locals only and tourists cannot use it. The island has no cars, no bikes — you will walk everywhere. Wear comfortable shoes.',
      },
      {
        day: 'Day 3: Xiamen → Nanjing Tulou',
        content:
          "Take a 3-hour bus from Xiamen to Nanjing Tulou cluster. The Nanjing Tulou are the most scenic group. Visit Tianluokeng Tulou Cluster (田螺坑) — five tulou arranged in a pattern locals call 'four dishes and a soup' (four round buildings around one square). Then Yuchang Lou (裕昌楼) — a 700-year-old tulou whose pillars lean at 15° (it is called the 'Leaning Tower of Pisa of Fujian'). Finish at Taxia Village (塔下村) — a Hakka village along a stream with a unique stone flagpole forest honouring successful scholars. Stay overnight in a tulou guesthouse.",
        tip: 'Stay overnight in a tulou — several have been converted into simple guesthouses. The rooms are basic (shared bathrooms, thin walls) but the experience of waking up inside a 500-year-old earthen fortress is unforgettable. The Hakka hosts will cook dinner for you — home-style Hakka food: salt-baked chicken, stuffed tofu, and yam noodles.',
      },
      {
        ...
        tip: 'Quanzhou is inexpensive by Fujian standards, with comfortable hotels near the old town. The city was recently discovered by Chinese tourists after its 2021 UNESCO listing but still sees very few Western visitors.',
      },
      {
        day: 'Day 5: Quanzhou',
        content:
          "Quanzhou was the starting point of the Maritime Silk Road and, during the Song-Yuan period (10th-14th centuries), one of the world's largest ports. Start at Kaiyuan Temple (开元寺, free) — a Tang dynasty Buddhist temple with twin stone pagodas that have survived since the 13th century. Behind the main hall, two stone pillars are carved with Hindu deities — a legacy of Tamil traders who lived here 700 years ago. Visit the Qingjing Mosque (清净寺) — China's oldest surviving mosque, built in 1009 AD. Lunch: Quanzhou oyster omelette (海蛎煎) and 'vermicelli paste' (面线糊) — rice noodles in a thick seafood broth. Afternoon: Maritime Museum (free) and the ancient Maritime Silk Road ship excavated from Quanzhou Bay. Evening: train back to Xiamen (30 min).",
      ...
      },
      {
        ...
        content:
          'If your flight is in the evening: visit the Xiamen Botanical Garden or cycle the Huandao Road coastal path (bikes easily rented along the route). Buy oolong tea (Fujian is the home of Tieguanyin and Dahongpao) and dried seafood as souvenirs.',
        tip: 'Fujian tea: Tieguanyin (铁观音, Iron Goddess of Mercy) — a floral oolong from Anxi with a delicate orchid fragrance — and Dahongpao (大红袍, Big Red Robe) — a legendary rock oolong from Wuyi Mountain with a deep, mineral-rich character. Buy at a tea market, not a tourist shop — the Xiamen Tea Market (厦门茶叶市场) is wholesale.',
      },
    ],
    related: [
      {
    ...
    stops: [
      {
        ...
        content:
          "Start at Victoria Peak (太平山) — take the Peak Tram (est. 1888) to the top for the classic Hong Kong skyline view. Walk the Peak Circle Walk (3.5 km, 1 hour) for 360° views. Descend to Central and walk the Mid-Levels Escalators — the world's longest outdoor covered escalator system (800m), past bars, galleries, and noodle shops. Lunch: dim sum at Tim Ho Wan (添好运, the world's most affordable Michelin-starred restaurant). Afternoon: Man Mo Temple (文武庙, free), dedicated to the gods of literature and war, with giant incense coils hanging from the ceiling. Evening: Star Ferry across Victoria Harbour (10 min, running since 1888) to Tsim Sha Tsui. Watch the Symphony of Lights (8pm) from the TST waterfront.",
      ...
      },
      {
        ...
        content:
          "Morning: A-Ma Temple (妈阁庙, free) — Macau's oldest temple (1488), dedicated to the sea goddess Mazu (Macau's name comes from 'A-Ma Gau' — 'Bay of A-Ma'). Visit the Macau Tower for the 360° view from 338m, or walk the Coloane Village — Macau's southernmost island with a fishing village atmosphere, pastel houses, and the original Lord Stow's Bakery. Afternoon: ferry back to Hong Kong (1 hr). Fly out from Hong Kong International Airport (HKG).",
    ...
    stops: [
      {
        day: 'Day 1: Guangzhou',
        content:
          'Fly into Guangzhou Baiyun Airport (CAN). Afternoon: Chen Clan Academy (陈家祠) — an 1894 ancestral hall that is the finest surviving example of Lingnan architecture, with intricate ceramic friezes, wood carvings, and ivory sculptures on every surface. Walk Shamian Island (沙面) — a sandbank island that was the British-French concession, now a quiet neighbourhood of colonial buildings, banyan trees, and cafes. Evening: dinner at a traditional Cantonese restaurant — roast goose (烧鹅), white-cut chicken (白切鸡), and claypot rice (煲仔饭).',
        tip: "The Chen Clan Academy is one of Guangzhou's best sights and a remarkable bargain. Every roof ridge, beam, and door panel is decorated with carvings and sculptures. It now houses the Guangdong Folk Art Museum. Go in the morning for the best light on the ceramic friezes.",
      },
      {
        day: 'Day 2: Guangzhou — Food & Culture',
        content:
          'Morning: dim sum at Panxi Restaurant (泮溪酒家, est. 1947) or Dian Dou De (点都德, a popular chain with consistent quality). Cantonese dim sum is the original and best — har gow (shrimp dumplings), siu mai (pork dumplings), char siu bao (BBQ pork buns), and egg tarts. Afternoon: visit the Mausoleum of the Nanyue King (南越王墓) — a 2,000-year-old tomb of a regional king from the Nanyue kingdom (204-111 BC), with a jade burial suit sewn with silk thread. Then Guangdong Museum (free, book ahead). Evening: Pearl River night cruise for the Canton Tower light show.',
      ...
      },
      {
        ...
        content:
          "Option A: Fly out from Shenzhen Bao'an Airport (SZX) or Guangzhou (CAN). Option B: take the 15-minute high-speed train from Shenzhen North to Hong Kong West Kowloon and continue to Hong Kong (see the Hong Kong & Macau route).",
        tip: 'Shenzhen airport (SZX) has good connections to major Chinese cities and international flights to Southeast Asia. The airport express (Line 11) from the city centre takes 30 minutes. If flying from Guangzhou (CAN), the train from Shenzhen to Guangzhou is 30 minutes.',
      },
    ],
    related: [
      {
