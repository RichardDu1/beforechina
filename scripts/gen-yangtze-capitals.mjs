      ...
      },
      {
        ...
        stops: [
          ...
          },
          {
            ...
            content: `Morning: train from Nanjing to Zhenjiang (20 min, ¥30). Zhenjiang (镇江) is a small city on the Yangtze with three scenic hills. Visit Jinshan Temple (金山寺, ¥65) — a Buddhist temple on a hilltop island where legend says a white snake spirit was trapped under the pagoda. After lunch (Zhenjiang is famous for vinegar — try the vinegar-braised pork ribs), take the 30-minute bus across the Yangtze to Yangzhou. Afternoon: Slender West Lake (瘦西湖, ¥150) — a long, narrow lake with willow-lined banks, arched stone bridges, and Ming-Qing pavilions. It is West Lake's smaller, more refined cousin.`,
            tip: "Slender West Lake is ¥150 — expensive by Chinese standards. The ticket is worth it for the Five Pavilion Bridge and the White Dagoba. Walk the full length (3 km, about 2 hours) from south to north. The lake is most beautiful in March-April when the peach blossoms and willows are in full display — '烟花三月下扬州' as the Tang poem says.",
          },
          {
            day: 'Day 4: Yangzhou → Shanghai',
            content: `Morning: Yangzhou morning tea (早茶) — this is the city's defining cultural experience. Go to Fuchun Tea House (富春茶社, est. 1885) or Yechun Tea House (冶春茶社) by 7:30am. Order san ding bao (三丁包, three-dice buns filled with chicken, pork, and bamboo shoots), crab roe soup dumplings (蟹黄汤包), and a pot of Biluochun green tea. The meal takes 1-2 hours — this is not fast food. Afternoon: visit Geyuan Garden (个园, ¥45), a Qing dynasty salt merchant's garden with bamboo groves and rockeries representing the four seasons. Then train back to Shanghai (2 hrs, ¥120).`,
    ...
    routes: [
      {
        ...
        stops: [
          ...
          },
          {
            ...
            content: `Morning: Xiangguo Temple (大相国寺, ¥45) — a Tang dynasty temple that was the Song dynasty's most important Buddhist institution, famous for its statue of Guanyin with 1,000 hands and eyes carved from a single ginkgo tree. Afternoon: 30-minute train to Zhengzhou (¥25), then fly out from Zhengzhou Xinzheng Airport (CGO).`,
