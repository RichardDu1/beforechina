...
const routes = [
  ...
  },
  {
    ...
    faqA: 'The climb is the point. The traditional route from Hongmen (红门) to the South Heavenly Gate (南天门) is 6,000+ stone steps, takes 4-6 hours, and has been walked by billions of pilgrims over 3,000 years. The steps are lined with inscriptions carved into the rock by emperors and poets. A cable car runs from the midway point and takes 8 minutes — but it misses the entire cultural experience. Climb up, cable car down (to save your knees).',
    stops: [
      {
        day: "Day 1: Arrive Tai'an",
        content:
          "Fly into Jinan Yaoqiang Airport (TNA) or take the high-speed train to Tai'an (1.5 hrs from Beijing; 2.5 hrs from Shanghai). Tai'an (泰安) is the city at the foot of Mount Tai. Afternoon: visit Dai Temple (岱庙, a modest entrance fee) at the mountain base — the temple where emperors performed pre-climb rituals before ascending Mount Tai. The temple has a 2,100-year-old cypress tree, Song dynasty murals, and imperial steles. Evening: buy supplies for the climb (water, snacks, a headlamp for the night climb option). Sleep early — you will wake at midnight if doing the night climb.",
      ...
      },
      {
        day: 'Day 2: Mount Tai',
        content:
          'Night climb option: wake at midnight, start climbing at 1am from Hongmen Gate. The 6,000+ steps take 4-5 hours at a steady pace. You climb through the night with hundreds of Chinese climbers — the atmosphere is festive, not solitary. Arrive at the South Heavenly Gate (南天门) by 5am, then walk 20 minutes to Jade Emperor Peak (玉皇顶, 1,545m) for sunrise. The sunrise over a sea of clouds is the payoff. Day climb option: start at 6am, climb 4-6 hours, reach the summit by midday. The views are still spectacular but the night climb has the better atmosphere. Descend by cable car and shuttle bus to save your knees. Afternoon: train to Qufu (20 min).',
        tip: 'Mount Tai has seasonal entrance pricing (peak vs off-peak). A cable car runs down the mountain. The night climb is cold — the summit is 10-15°C colder than the base and windy. Bring a warm layer and a windbreaker. The summit has vendors renting military coats — they are ugly but warm. The sunrise is visible about 50% of the time — clouds and fog obscure it. Check the forecast.',
      },
      {
        day: 'Day 3: Qufu',
        content:
          "Qufu is a small city built around the legacy of Confucius. Visit the Confucius Temple (孔庙) — China's second-largest ancient building complex after the Forbidden City, with 466 halls and pavillions built over 2,000 years. The temple is a forest of steles, ancient cypresses, and yellow-glazed imperial roofs. Then the Confucius Mansion (孔府) — the residence of Confucius's direct descendants for 77 generations (the last descendant still lives in Taiwan). Finally, the Confucius Cemetery (孔林) — a 200-hectare forest where Confucius and 100,000+ of his descendants are buried. The tomb of Confucius is a simple mound with a stele — understated, fitting his philosophy.",
        tip: "A combined ticket for the Temple, Mansion, and Cemetery is available and saves you money compared to buying separately. The three sites are walkable from each other. The Temple is the highlight — give it 2 hours. The Cemetery is a peaceful forest of ancient trees and stone steles, best in the late afteroon light. Qufu has a touristy 'Confucius culture street' selling calligraphy brushes and Confucius-branded everything — skip it.",
      },
      {
        day: 'Day 4: Qufu → Depart',
        content:
          "Fly out from Jinan Yaoqiang Airport (TNA), 2 hours from Qufu by bus. Alternatively, take the high-speed train from Qufu East to Beijing (2 hrs) or Shanghai (3 hrs). If you have a late departure, visit the Nishan Holy Land (尼山圣境, ticketed) — a massive new Confucius theme park with a 72m bronze statue of Confucius and a spectacular evening light show. It is China's attempt to make Confucius Instagram-worthy.",
        tip: 'The Nishan Holy Land is a state-funded Confucius theme park opened in 2018. The 72m statue (Confucius lived to 72) is genuinely impressive. The evening drone and light show is spectacular in a very Chinese way — 500 drones forming Confucius quotes in the sky. It is 40 minutes from Qufu by bus.',
      },
    ],
    related: [
      {
    ...
    stops: [
      {
        ...
        content:
          "Fly into Jingdezhen Luojia Airport (JDZ) or take the high-speed train from Shanghai (4 hrs), Hangzhou (3 hrs), or Nanchang (1 hr). Afternoon: Jingdezhen Ceramic History Museum (景德镇陶瓷博物馆, free) — the world's largest ceramics museum, covering the history of Chinese porcelain from the Neolitic to the present. The museum building is a replica of a Song dynasty kiln. Evening: walk the Ancient Kiln Folk Customs Museum area (古窑民俗博览区, a modest entrance fee) — a reconstructed Ming-Qing kiln village with working potters demonstrating traditional techniques.",
        tip: 'The Ancient Kiln Folk Customs Museum (ticketed) is touristy but worthwile — you watch master potters throw porcelain on kick-wheels, paint blue-and-white designs, and fire wood kilns. The potters are genuine craftspeople, not actors. You can buy their work — a hand-painted teacup costs very little directly from the maker and makes for an authentic, meaningful souvenir.',
      },
      {
        day: 'Day 2: Jingdezhen — Porcelain Immersion',
        content:
          'Morning: visit a porcelain workshop for a hands-on experience. The Pottery Workshop (乐天陶社) in the Sculpture Factory area runs half-day classes where you throw a bowl on a wheel, paint blue-and-white designs, and fire your piece (it can be shipped to your home, with international shipping easily arranged). Afternoon: explore the Sculpture Factory area (雕塑瓷厂) — a former state-owned factory turned into a creative park of artist studios, galleries, and cafes. Saturday mornings have the best creative market in China (乐天集市, 8am-12pm) — young ceramic artists selling their work. Evening: Taoxichuan (陶溪川) — a former state porcelain factory turned into a cultural district of galleries, design shops, and restaurants in red-brick industrial buildings.',
        tip: 'The Saturday morning Creative Market (乐天集市) at the Sculpture Factory is the best time to be in Jingdezhen — 100+ young ceramic artists selling their work, from affordable earings to gallery-quality vases. The market runs 8am-12pm. Arrive early — the best pieces sell in the first hour. This is where Chinese galleries scout new talent.',
      },
      {
        day: 'Day 3: Jingdezhen → Lushan',
        content:
          "Take the 2-hour high-speed train from Jingdezhen North to Jiujiang, then 1-hour bus up the mountain to Lushan (庐山, entrance fee applies plus shuttle bus). Lushan is a mountain resort at 1,100m where missionaries built stone villas in the late 19th century and China's leaders followed. The mountain has over 600 villas representing 18 countries' architectural styles. Check into a hotel (converted villa or modern). Afternoon: walk the villa trail — visit the Meilu Villa (美庐, a small entrance fee), the former summer residence of Chiang Kai-shek and later Mao Zedong. The villa is preserved as it was when Mao stayed here in 1959, with his bedroom and study intact. Evening: Lushan speciality — stone fish (石鱼), tiny fish from the mountain streams, and stone ear fungus (石耳).",
        tip: 'Lushan entrance: ticketed, with a separate shuttle bus fee. The mountain has a permanent population of 20,000 and a town (Guling, 牯岭镇) at the summit with hotels, restaurants, and shops. The temperature at 1,100m is 8-10°C cooler than the plains — Lushan has been a summer escape for 100 years. The mountain is often in clouds — embrace the mist.',
      },
      {
        day: 'Day 4: Lushan',
        content:
          "Full day hiking Lushan. The mountain's main sights are waterfalls, peaks, and the views of the Yangtze River and Poyang Lake from the summit. Visit the Three-Step Waterfall (三叠泉, a modest entrance fee) — Lushan's most famous waterfall, descending in three cascades over 155m. The hike is 3,000+ steps down to the base and back up — hard work but worth it. Then the Immortal's Cave (仙人洞) — a natural cave where a Daoist immortal supposedly lived, with a view over a sea of clouds. Lushan is also famous for its 'cloud tea' (云雾茶) — tea grown in the mountain mist, one of China's top 10 teas. Visit a tea plantation for a tasting.",
        tip: 'The Three-Step Waterfall (三叠泉) is a 3,000-step descent (and climb back up). The steps are steep and uneven. A cable car covers the flatter approach but you still have to climb 1,500+ steps to the base. Go early morning (7am) to avoid the crowds. The waterfall is most powerful after rain.',
      },
      {
        day: 'Day 5: Lushan → Nanchang → Depart',
        content:
          "Morning: final Lushan walk — the Brocade Valley (锦绣谷) is a 1.5 km cliffside path through misty peaks and rock formations, ending at the Immortal's Cave. Then descend the mountain by bus (1 hr) to Jiujiang. Train from Jiujiang to Nanchang (1 hr) for your flight out. If you have time in Nanchang: visit the Tengwang Pavillion (滕王阁, a modest entrance fee) — a Tang dynasty pavillion on the Gan River, one of China's 'Four Great Towers', or the Nanchang Star (南昌之星, ticketed) — a 160m Ferris wheel with views over the city.",
    ...
    stops: [
      {
        ...
        tip: "Sanya's beaches ranked: Yalong Bay (best sand, clearest water, sunbeds available for a small fee), Sanya Bay (longest, free, most convenient), Dadonghai (busy, lots of Russians, free), Haitang Bay (newest, luxury resorts). The water is warm year-round (22-28°C). The best swimming is March-November.",
      },
      {
        day: 'Day 2: Sanya — Beach Day',
        content:
          "Full beach day. Yalong Bay has the classic white-sand crescent beach — 7.5 km of sand with clear water. The beach is lined with resorts but the sand is public (Chinese law requires all beaches to be publicly accessible). Rent a sunbed for a small fee, swim, and enjoy a fresh coconut from a beach vendor. Afternoon: Nanshan Temple (南山寺, a modest entrance fee) — a massive Buddhist complex on the coast with a 108m statue of Guanyin (the Goddess of Mercy) rising from the sea on an artificial island. The statue is visible from the plane as you land. Evening: Sanya Duty-Free Shopping Complex (the world's largest duty-free mall) if you want luxury shopping.",
      ...
      },
      {
        ...
        content:
          "Morning: water sports at Wuzhizhou Island (蜈支洲岛, ticketed including ferry) — a small island 30 minutes off the coast with the clearest water in Sanya. Snorkelling, diving, jet skiing, and parasailing are all available (prices vary by activity — book ahead for the best rates). The coral is not world-class (Hainan's reefs have suffered from bleaching) but the water is clear and the fish are plentiful. Afternoon: Nantian Hot Springs (南田温泉, ticketed) — volcanic hot springs with 30+ pools of varying temperatures, surrounded by tropical gardens. Evening: Sanya Romance Park (三亚千古情, ticketed) — a theatrical show about Sanya's history, directed by the same company that does the Hangzhou Impression shows.",
        tip: "Wuzhizhou Island ferry: ticketed, includes island entrance. The ferry takes 20 minutes and can be rough. Book water sports online (Trip.com) for better prices than on the island. Nantian Hot Springs has pools ranging from 28-45°C, including a 'fish therapy' pool where small fish nibble dead skin (a small extra fee).",
      },
      {
        day: 'Day 5: Sanya → Haikou (Optional)',
        content:
          "Option A: stay in Sanya for more beach time. Option B: take the 1.5-hour high-speed train from Sanya to Haikou. Haikou is Hainan's capital and has a more local, less resort feel. Visit Qilou Old Street (骑楼老街) — a neighbourhood of colonial-era arcade buildings built by returning overseas Chinese in the 1920s. Visit the Hainan Museum (free) for the island's history. Lunch: Haikou's version of Wenchang chicken and Hainan rice noodles (海南粉). Afternoon: volcanic cluster geopark (海口火山群, a modest entrance fee) — a dormant volcano 15 km from Haikou with a crater you can walk into. Evening: train back to Sanya (1.5 hrs) or stay in Haikou and fly out from Haikou Meilan Airport (HAK).",
      ...
      },
      {
        ...
        content:
          "Fly out from Sanya (SYX) or Haikou (HAK). Both airports have flights to major Chinese cities and international connections to Southeast Asia. If extending: Hainan has a 51km coastal road from Sanya to Lingshui — rent a car and drive it. The road passes through fishing villages, coconut groves, and viewpoints over the South China Sea. Or visit the Bo'ao Forum site (博鳌, 1.5 hrs from Haikou) — the 'Davos of Asia', a conference centre on a river estuary.",
