  ...
  // --- DONGBEI ---
  {
    ...
    stops: [
      ...
      },
      {
        ...
        content:
          'Fly out from Harbin. If your flight is in the evening, visit the Unit 731 Museum (free, 1.5 hrs from Harbin centre) — a Japanese biological warfare research facility from WWII, now a somber museum. It is heavy but historically important. Alternatively, visit the Harbin Polarland (¥150) for beluga whale shows and penguins — lighter fare for a departure day.',
  ...
  },
  {
    ...
    stops: [
      ...
      },
      {
        ...
        tip: 'Wanda Changbaishan ski passes: ¥450-650/day in peak season (December-February), ¥300-450 in shoulder season. The resort is less crowded than Yabuli (Harbin) and the snow quality is better. The runs are intermediate-friendly — not extreme terrain. The resort has English-speaking instructors (¥400-600/hr).',
      },
      {
      ...
      },
      {
        ...
        content:
          'Morning: visit the Tumen border area (图们) — a bridge across the Tumen River where you can look into North Korea (the city of Namyang is visible). The border observation deck (¥25) has telescopes pointed at the North Korean side. Afternoon: fly out from Yanji Chaoyangchuan Airport (YNJ) or take the 2-hour high-speed train to Changchun (¥100) for connections.',
  ...
  // --- ZHANGJIAJIE ---
  {
    ...
    stops: [
      ...
      },
      {
        ...
        content:
          "Enter the park at 7am (¥228, 4-day pass). Take the Bailong Elevator (百龙天梯, ¥72) — a glass elevator built against a 326m cliff face, the world's tallest outdoor elevator. At the top, walk to Yuanjiajie Scenic Area (袁家界) — the Avatar Hallelujah Mountains viewpoint. The 'Southern Sky Pillar' (南天一柱), renamed 'Avatar Hallelujah Mountain' in 2010, is the pillar that inspired the film. Then shuttle bus to Tianzi Mountain (天子山) — panoramic views of the pillar forest from 1,262m. Descend by cable car (¥72).",
      ...
      },
      {
        ...
        content:
          "Morning: Tianmen Mountain (天门山, ¥258) — take the world's longest cable car (7.5 km, 30 minutes) from Zhangjiajie city centre to the summit at 1,430m. The cable car rises over the city, farmland, and then up the mountain face. At the top, walk the cliff-hanging walkway (玻璃栈道) — a 60m glass path bolted to a vertical cliff. Then walk to Tianmen Cave (天门洞) — a natural arch 131.5m high in the mountain, reached by the 999-step 'Stairway to Heaven' or an escalator inside the mountain. Descend by bus on the 99-bend road (通天大道), one of the world's most dramatic roads. Afternoon: fly out or take the train.",
  ...
  // --- HUANGSHAN ---
  {
    ...
    stops: [
      ...
      },
      {
        ...
        content:
          "Enter the mountain at 6:30am. Take the Yungu Cable Car (云谷索道, ¥80) from the eastern side to the summit area. The cable car rises 1,000m through the clouds — when you emerge above the cloud layer, the view is unforgettable. The summit trail is a 6-8 km loop past the famous sights: Begin-to-Believe Peak (始信峰), the Brush Pen Peak (梦笔生花), and Lion Peak (狮子峰) for the first sea-of-clouds panorama. Check into your summit hotel. Afternoon: hike to the West Sea Grand Canyon (西海大峡谷) — a 2-3 hour loop through the most dramatic section of Huangshan, with paths carved into vertical cliffs and views of the canyon's granite spires. Sunset at Bright Summit Peak (光明顶, 1,860m) — the highest point on the mountain.",
