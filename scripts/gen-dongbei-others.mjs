...
export const metadata: Metadata = {
  title: '${esc(route.metaTitle)} | BeforeChina',
  description: '${esc(route.metaDesc)}',
...
`;
  ...
  console.log(`✅ ${route.dir}/${route.slug}`);
}

// ====== DONGBEI + YANGTZE CRUISE + ZHANGJIAJIE + HUANGSHAN ======
...
const routes = [
  // --- DONGBEI ---
  {
    ...
    kicker: 'Dongbei',
    title: "Harbin & Snow Town: China's Winter Wonderland",
    subtitle:
      "The world's largest ice sculpture festival, a village buried under 2 metres of powder snow, and the warmth of Dongbei cuisine in -30°C — this is winter in China's far northeast.",
    duration: '5-6 days',
    route: 'Harbin → Snow Town → Yabuli → Harbin',
    heroImage: '/images/destinations/dongbei.webp',
    heroImageAlt: 'Harbin Ice and Snow World illuminated at night',
    highlights: [
      {
        icon: 'clock',
        title: '5–6 Days',
    ...
    stops: [
      ...
      },
      {
        ...
        content:
          'Afternoon-evening: Harbin Ice and Snow World (哈尔滨冰雪大世界) — the main event. The park covers 600,000 m² and features buildings, castles, slides, and sculptures all made of ice blocks from the Songhua River. The ice is 50-80cm thick and crystal clear. Go at 3pm to see the sculptures in daylight (they are blue-white) and stay for the neon light show after dark (4:30pm in winter). The ice slides are terrifying and essential. The temperature inside the park is -25°C to -35°C — dress like you are going to the Arctic.',
        tip: 'Ice and Snow World tickets can be booked on Trip.com or at the gate. The ice slides are free — the queue for the longest slide (300m) can be 1 hour. Go on a weekday to avoid the worst crowds. The park has warming huts with hot drinks — use them every 45 minutes. Frostbite is a real risk. If your fingers or toes go numb, go inside immediately.',
      },
      {
        day: 'Day 3: Harbin → Snow Town',
        content:
          'Drive 5 hours from Harbin to China Snow Town (中国雪乡). Snow Town is a village in a mountain valley where a unique microclimate produces reliable, deep powder snow — 2 metres accumulation from November to March. The village is a cluster of wooden houses with distinctive mushroom-shaped snow caps on the roofs. Walk the main street, climb the wooden walkway to the observation deck for the classic Snow Town panorama (red lanterns glowing against the white snow at dusk), and try sledding and snow tubing. Stay overnight in a local guesthouse (kang bed — a heated brick platform).',
        tip: 'Snow Town entrance includes a shuttle bus. The village is remote — 5 hours from Harbin on icy roads. Book transport through your hotel or a tour company. The guesthouses have kang beds (炕) — a heated brick platform you sleep on. It is the traditional Dongbei heating method and is genuinely warm. The food in Snow Town is simple and hearty — hearty northeastern fare suited to the remote mountain setting.',
      },
      {
        day: 'Day 4: Snow Town → Yabuli → Harbin',
        content:
          "Morning: final Snow Town photos in the early light (the snow is at its most pristine before the crowds). Then drive 2.5 hours to Yabuli Ski Resort (亚布力滑雪场) — China's largest ski resort. Yabuli has 46 ski runs and hosted the 1996 Asian Winter Games. A half-day lift pass can be booked at the resort. If you are a beginner, book a lesson — the instructors speak basic English. Afternoon: drive 3 hours back to Harbin. Evening: Harbin beer and Russian food on Central Street.",
        tip: "Yabuli is China's best ski resort but it is not Whistler or Chamonix. Manage expectations: the snow is partly natural, partly artificial. The runs are shorter and the facilities are older than Western resorts. But skiing in China is an experience in itself, and the Dongbei winter landscape is unique. Rent gear at the resort — skis, boots, poles, and helmet are all available.",
      },
      {
        day: 'Day 5: Harbin',
        content:
          'Morning: Sun Island Snow Sculpture Expo (太阳岛雪博会) — the daytime counterpart to Ice and Snow World, featuring massive snow sculptures (not ice) carved by international teams. The sculptures are up to 30m high and incredibly detailed. Afternoon: Siberian Tiger Park (东北虎林园) — a controversial but unique wildlife park with 500+ Siberian tigers. You ride in a caged bus through the enclosures. You can buy meat to feed the tigers through the bus bars. Evening: Harbin dumpling feast — Dongbei dumplings (饺子) are the best in China.',
      ...
      },
      {
        ...
        content:
          'Fly out from Harbin. If your flight is in the evening, visit the Unit 731 Museum (free, 1.5 hrs from Harbin centre) — a Japanese biological warfare research facility from WWII, now a somber museum. It is heavy but historically important. Alternatively, visit the Harbin Polarland for beluga whale shows and penguins — lighter fare for a departure day.',
        tip: 'Harbin airport is 35 km from the city (40-60 min by taxi). The airport bus departs from Central Street. In winter, allow extra time — snow can delay traffic. The airport is small and efficient — 1 hour before your flight is sufficient.',
      },
    ],
    related: [
      {
        ...
        label: 'Changbaishan',
        description: 'Add the North Korean border mountain and hot springs to your Dongbei trip.',
  ...
  },
  {
    ...
    kicker: 'Dongbei',
    title: 'Changbaishan: Heavenly Lake on the North Korean Border',
    subtitle:
      "A volcanic crater lake straddling the China-North Korea border, natural hot springs in -30°C, and China's best powder skiing — Changbaishan is Dongbei's wildest destination.",
    duration: '4-5 days',
    route: 'Beijing/Shanghai → Changbaishan → Yanji (optional)',
    heroImage: '/images/destinations/dongbei.webp',
    heroImageAlt: 'Changbaishan Heavenly Lake crater on the North Korean border',
    highlights: [
      {
        icon: 'clock',
        title: '4–5 Days',
    ...
    experienceTypes: ['nature', 'adventure'],
    overview:
      "Changbaishan (长白山, 'Ever-White Mountain') is a dormant volcano on the China-North Korea border. Its crater lake, Tianchi (天池, 'Heavenly Lake'), sits at 2,189m and is the world's highest volcanic crater lake. The mountain is sacred to both Koreans (who consider it the birthplace of the Korean people) and Manchus (who considered it their ancestral homeland). In winter, Changbaishan offers China's best powder skiing at the Wanda Resort. In summer, it is a cool escape with wildflowers and alpine scenery. The North Korean border runs through the middle of the lake — you can literally look into North Korea from the viewing platform.",
    faqQ: 'Can you actually see North Korea from Changbaishan?',
    faqA: 'Yes. The crater lake is bisected by the China-North Korea border. From the western slope viewing platform (accessible from the Chinese side), you look across the lake at the North Korean side. You will see North Korean territory but not North Korean people — the North Korean side of the mountain is undeveloped. The border is marked by a stone pillar at the viewing platform. You can take photos but do not cross — the Chinese military patrols the area.',
    stops: [
      {
        day: 'Day 1: Arrive Changbaishan',
        content:
          'Fly into Changbaishan Airport (NBS) from Beijing (2 hrs), Shanghai (3 hrs), or Harbin (1 hr). The airport is 30 minutes from the Wanda Resort (万达度假区) — a ski resort town with hotels, restaurants, and hot springs. Check into your hotel. Afternoon: explore the resort, rent ski gear for tomorrow. Evening: outdoor hot springs — soaking in 40°C volcanic water while the air temperature is -20°C, steam rising into the pine forest.',
    ...
    related: [
      {
        ...
        description: "Combine with Harbin's Ice Festival for the full Dongbei winter experience.",
        image: '/images/destinations/dongbei.webp',
      ...
      },
      {
        href: '/golden-triangle/beijing-in-depth',
        label: 'Beijing In Depth',
        description: 'Beijing is the gateway to Dongbei — fly via Beijing for a capital stopover.',
        image: '/images/destinations/golden-triangle.webp',
        imageAlt: 'The Forbidden City in Beijing',
        days: '4–5 days',
      },
  ...
  // --- YANGTZE CRUISE ---
  {
    ...
    kicker: 'Yangtze Cruise',
    title: 'Yangtze River Cruise: Chongqing to Yichang Through the Three Gorges',
    subtitle:
      "Four days on the world's third-longest river, through limestone gorges, past the largest dam ever built, and into tributary streams on small boats — the classic Yangtze cruise.",
    duration: '4-5 days',
    route: 'Chongqing → Fengdu → Three Gorges → Three Gorges Dam → Yichang',
    heroImage: '/images/destinations/yangtze-cruise.webp',
    heroImageAlt: 'Yangtze River Three Gorges limestone cliffs',
    highlights: [
      {
        icon: 'clock',
        title: '4–5 Days',
    ...
    overview:
      "The Yangtze River cruise from Chongqing to Yichang is one of China's classic travel experiences. Over 4 days (downstream) or 5 days (upstream), you travel 660 km through the Three Gorges — Qutang (the shortest and most dramatic), Wu (the deepest and most beautiful), and Xiling (the longest) — on a river that has been China's main east-west artery for millennia. The cruise includes shore excursions to the Three Gorges Dam (the world's largest hydroelectric project), the 'Ghost City' of Fengdu, and the Shennong Stream (a tributary explored by small wooden boats). It is a comfortable, scenic way to travel between Chongqing and Yichang.",
    faqQ: 'Is the Yangtze cruise worth it after the Three Gorges Dam raised the water level?',
    faqA: 'The water level rose 100m after the dam was completed in 2003, which changed the gorges — they are narrower at the top than at the bottom now, and some archaeological sites were submerged. But the gorges are still dramatic (the cliffs are 1,000m+ high, so 100m of water rise is only 10% of the height), and the cruise is still a wonderful experience. The dam itself is an engineering marvel worth seeing. Go with realistic expectations: this is a comfortable river cruise through dramatic scenery, not an untouched wilderness experience.',
    stops: [
      {
        day: 'Day 1: Chongqing → Board Ship',
        content:
          "Arrive Chongqing (重庆). Board your cruise ship at Chaotianmen Dock in the late afternoon/evening. Ships typically depart at 9-10pm. After boarding: safety briefing, welcome dinner, and watching Chongqing's skyline lights as you sail away. Chongqing's hilly skyline is spectacular at night — the city is built on a peninsula where the Yangtze and Jialing rivers meet.",
      ...
      },
      {
        ...
        content:
          "Morning shore excursion to Fengdu Ghost City (丰都鬼城, included in cruise fare) — a Ming dynasty temple complex on Ming Mountain dedicated to the afterlife, with statues of demons, judges of the dead, and the 'Bridge of Helplessness' you must cross to reach the afterlife. Alternatively, some cruises visit Shibaozhai (石宝寨) — a 12-storey wooden pagoda built against a 200m rock pillar, now an island after the dam raised the water. Afternoon: cruising through the countryside. Evening: captain's welcome dinner.",
      ...
      },
      {
        ...
        content:
          "Morning: enter Qutang Gorge (瞿塘峡) — the shortest (8 km) and most dramatic of the Three Gorges, with cliffs rising vertically from the water. This is the gorge on the ¥10 note. Then Wu Gorge (巫峡) — the longest and most beautiful (45 km), with 12 peaks rising through the mist. The ship's guide narrates the peaks and their legends. Afternoon: transfer to a small boat for the Shennong Stream (神农溪) excursion — a tributary through a narrow gorge where the original water level is visible on the cliffs. Local Tujia boatmen pole the boats. Evening: pass through the 5-stage ship locks at the Three Gorges Dam (3-4 hours, fascinating engineering).",
  ...
  // --- ZHANGJIAJIE ---
  {
    ...
    kicker: 'Hunan',
    title: 'Zhangjiajie: The Avatar Mountains of Hunan',
    subtitle:
      "3,000 sandstone pillars rising through mist, the world's longest and highest glass bridge, and a cliff-hanging walkway at 1,430m — Zhangjiajie is China's most surreal landscape.",
    duration: '4-5 days',
    route: 'Zhangjiajie National Park → Grand Canyon Glass Bridge → Tianmen Mountain',
    heroImage: '/images/destinations/zhangjiajie.webp',
    heroImageAlt: 'Zhangjiajie sandstone pillars rising through mist',
    highlights: [
      {
        icon: 'clock',
        title: '4–5 Days',
    ...
    experienceTypes: ['nature', 'adventure'],
    overview:
      "Zhangjiajie's sandstone pillars — 3,000 of them, up to 200m tall, rising vertically from a subtropical forest — are one of the most otherworldly landscapes on Earth. They directly inspired the floating Hallelujah Mountains in James Cameron's Avatar. The area is now China's first UNESCO Global Geopark and one of its most popular natural attractions. This route covers the three main sites: Zhangjiajie National Forest Park (the pillars), the Grand Canyon Glass Bridge (the world's longest and highest), and Tianmen Mountain (the cliff-hanging walkway and the 999-step 'Stairway to Heaven').",
    faqQ: 'Is Zhangjiajie as crowded as people say?',
    faqA: 'Yes, in peak season (July-August, Chinese holidays). The park receives 50 million+ visitors annually, most of them Chinese domestic tourists. The key to avoiding crowds: go in shoulder season (April, September, November), enter the park at opening (7am), and stay inside the park or at the park gate (so you can enter before the tour buses arrive at 9am). The park is large enough that even on a busy day, you can find quiet trails if you walk away from the main viewpoints.',
    stops: [
      {
        day: 'Day 1: Arrive Zhangjiajie',
        content:
          "Fly into Zhangjiajie Hehua Airport (DYG) or take the high-speed train from Changsha (2.5 hrs). Check into accommodation at Wulingyuan (the town at the park entrance). Afternoon: Zhangjiajie Grand Canyon Glass Bridge (张家界大峡谷玻璃桥) — the world's longest (430m) and highest (300m above the canyon floor) glass-bottom bridge. Walking across a transparent bridge suspended 300m above a canyon is genuinely terrifying. After the bridge, walk the Grand Canyon trail (2-3 hours) through waterfalls, pools, and a limestone cave. Evening: Wulingyuan town for dinner.",
        tip: 'The Glass Bridge ticket must be booked in advance — it sells out. Book on Trip.com or the official WeChat account. No large bags, cameras with detachable lenses, or selfie sticks allowed on the bridge (they provide lockers). The canyon walk after the bridge is a 2-3 hour downhill hike with beautiful scenery — wear good shoes.',
      },
      {
        day: 'Day 2: Zhangjiajie National Forest Park — Yuanjiajie & Tianzi Mountain',
        content:
          "Enter the park at 7am — a 4-day pass can be purchased at the gate. Take the Bailong Elevator (百龙天梯) — a glass elevator built against a 326m cliff face, the world's tallest outdoor elevator. At the top, walk to Yuanjiajie Scenic Area (袁家界) — the Avatar Hallelujah Mountains viewpoint. The 'Southern Sky Pillar' (南天一柱), renamed 'Avatar Hallelujah Mountain' in 2010, is the pillar that inspired the film. Then shuttle bus to Tianzi Mountain (天子山) — panoramic views of the pillar forest from 1,262m. Descend by cable car.",
      ...
      },
      {
        ...
        content:
          "Morning: Tianmen Mountain (天门山) — take the world's longest cable car (7.5 km, 30 minutes) from Zhangjiajie city centre to the summit at 1,430m. The cable car rises over the city, farmland, and then up the mountain face. At the top, walk the cliff-hanging walkway (玻璃栈道) — a 60m glass path bolted to a vertical cliff. Then walk to Tianmen Cave (天门洞) — a natural arch 131.5m high in the mountain, reached by the 999-step 'Stairway to Heaven' or an escalator inside the mountain. Descend by bus on the 99-bend road (通天大道), one of the world's most dramatic roads. Afternoon: fly out or take the train.",
        tip: 'Tianmen Mountain ticket includes the cable car up and bus down (or vice versa). Book a morning slot — the cable car queue can be 2-3 hours from 9am. The cliff walkway (shoe covers required) is more psychological than actually dangerous — the glass is thick and the walkway is bolted into the cliff. The 999 steps down through Tianmen Cave are steep and can be slippery — the escalator inside the mountain is an alternative.',
      },
    ],
    related: [
      {
  ...
  // --- HUANGSHAN ---
  {
    ...
    kicker: 'Anhui',
    title: 'Huangshan: The Yellow Mountain & Huizhou Villages',
    subtitle:
      "China's most painted mountain — granite peaks rising through a sea of clouds, ancient pine trees clinging to cliffs, and nearby Hongcun, the 900-year-old village that inspired Crouching Tiger, Hidden Dragon.",
    duration: '3-4 days',
    route: 'Huangshan City → Huangshan Mountain → Hongcun/Xidi → Huangshan City',
    heroImage: '/images/destinations/huangshan.webp',
    heroImageAlt: 'Huangshan granite peaks above a sea of clouds',
    highlights: [
      {
        icon: 'clock',
        title: '3–4 Days',
    ...
    stops: [
      ...
      },
      {
        ...
        content:
          "Enter the mountain at 6:30am. Take the Yungu Cable Car (云谷索道) from the eastern side to the summit area. The cable car rises 1,000m through the clouds — when you emerge above the cloud layer, the view is unforgettable. The summit trail is a 6-8 km loop past the famous sights: Begin-to-Believe Peak (始信峰), the Brush Pen Peak (梦笔生花), and Lion Peak (狮子峰) for the first sea-of-clouds panorama. Check into your summit hotel. Afternoon: hike to the West Sea Grand Canyon (西海大峡谷) — a 2-3 hour loop through the most dramatic section of Huangshan, with paths carved into vertical cliffs and views of the canyon's granite spires. Sunset at Bright Summit Peak (光明顶, 1,860m) — the highest point on the mountain.",
...
console.log(`\nDone. ${routes.length} Dongbei + Yangtze Cruise + Zhangjiajie + Huangshan pages.`);
