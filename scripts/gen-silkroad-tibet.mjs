...
const routes = [
  // --- SILK ROAD ---
  {
    dir: "silk-road", slug: "xian-lanzhou-dunhuang",
    metaTitle: "Xian-Lanzhou-Dunhuang (7-8 Days) | Silk Road Highlights Guide",
    metaDesc: "The classic Chinese Silk Road route: Xian's Terracotta Warriors, Lanzhou's Yellow River, Zhangye's rainbow mountains, Jiayuguan's Great Wall fort, and Dunhuang's Mogao Caves.",
    kicker: "Silk Road · 7-8 Days", title: "Xian, Lanzhou & Dunhuang: The Classic Silk Road",
    subtitle: "From the Terracotta Warriors to the rainbow mountains of Zhangye, Jiayuguan's desert fortress, and Dunhuang's Mogao Caves — the Silk Road's greatest hits.",
    duration: "7-8 days", route: "Xian → Lanzhou → Zhangye → Jiayuguan → Dunhuang", budget: "$800-1,200/person",
    overview: "The Silk Road was not one road but a network of trade routes connecting China to Central Asia, Persia, and the Mediterranean for over 1,500 years. This route follows the Hexi Corridor (河西走廊) — the 1,000km narrow passage between the Tibetan Plateau and the Gobi Desert that was the Silk Road's main artery. You will travel from Xian (the eastern terminus) to Dunhuang (the western gateway), passing through Zhangye's rainbow-coloured mountains, Jiayuguan's Ming dynasty fortress at the Great Wall's western end, and the Mogao Caves — one of the world's greatest repositories of Buddhist art.",
  ...
  // --- TIBET ---
  {
    dir: "tibet", slug: "lhasa-shigatse-everest",
    metaTitle: "Lhasa-Shigatse-Everest (8-10 Days) | Tibet Travel Guide",
    metaDesc: "The essential Tibet route: Lhasa's Potala Palace and Jokhang Temple, Shigatse's Tashilhunpo Monastery, and Everest Base Camp — 8-10 days on the Roof of the World.",
    kicker: "Tibet · 8-10 Days", title: "Lhasa, Shigatse & Everest Base Camp: The Roof of the World",
    subtitle: "The Potala Palace at dawn, monks debating in Jokhang Temple, the turquoise Yamdrok Lake at 4,441m, and Everest Base Camp at 5,150m — Tibet's essential route.",
    duration: "8-10 days", route: "Lhasa → Yamdrok Lake → Gyantse → Shigatse → Everest Base Camp → Lhasa", budget: "$1,200-2,000/person",
    overview: "Tibet is not a casual destination — the altitude (Lhasa is at 3,650m, Everest Base Camp at 5,150m), the permit requirements, and the logistics make it one of the most complex trips in China. But it is also one of the most extraordinary: the Potala Palace rising 13 storeys above Lhasa, monks debating Buddhist philosophy in Jokhang Temple, turquoise lakes at 4,400m surrounded by snow peaks, and the north face of Everest from Base Camp. This route covers Tibet's essential sites in 8-10 days, with altitude acclimatisation built in.",
    faqQ: "Do I need a special permit to visit Tibet?", faqA: "Yes. Foreign travellers need (1) a Chinese visa, (2) a Tibet Travel Permit (TTP) issued by the Tibet Tourism Bureau, and (3) if visiting Everest Base Camp or other restricted areas, an Aliens' Travel Permit (ATP). You MUST book through a registered Tibetan travel agency — independent travel is not allowed. The agency handles all permits. Allow 10-15 days for permit processing. You will be met at the airport or train station by your guide.",
    stops: [
  ...
  {
    dir: "tibet", slug: "lhasa-namtso-lake",
    metaTitle: "Lhasa & Namtso Lake (5-6 Days) | Short Tibet Itinerary",
    metaDesc: "A shorter Tibet route: Lhasa's Potala Palace, Jokhang Temple, and Namtso Lake — one of the world's highest salt lakes at 4,718m.",
    kicker: "Tibet · 5-6 Days", title: "Lhasa & Namtso Lake: Tibet's Holy City & Heavenly Lake",
    subtitle: "Lhasa's Potala Palace, the Jokhang Temple, and Namtso — a 1,920 km² salt lake at 4,718m, one of the most beautiful places on the Tibetan Plateau.",
    duration: "5-6 days", route: "Lhasa → Namtso Lake → Lhasa", budget: "$800-1,200/person",
    overview: "For travellers who want a taste of Tibet without the long drives to Everest. This route focuses on Lhasa and Namtso Lake (纳木错) — one of the world's highest and largest salt lakes at 4,718m, 1,920 km² of turquoise water ringed by snow-capped peaks. Lhasa gives you Tibetan Buddhism's holiest sites; Namtso gives you the Tibetan Plateau's stark, high-altitude beauty. The 5-6 day timeline is ideal for those with limited time or as an add-on to a longer China trip.",
    faqQ: "Can I visit Tibet independently?", faqA: "No. All foreign travellers to Tibet must book through a registered travel agency, have a licensed guide, and travel on a pre-arranged itinerary with a private vehicle. The Tibet Travel Permit (TTP) is checked at airports, train stations, and checkpoints. Independent travel has not been permitted since 2008. Your agency handles all permits, transport, guides, and accommodation."    ,
    stops: [
