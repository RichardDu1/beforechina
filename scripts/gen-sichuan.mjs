...
const routes = [
  {
    ...
    metaDesc: "Chengdu pandas, Jiuzhaigou's turquoise lakes, and Huanglong's travertine pools — the classic Sichuan nature route in 5-6 days.",
    kicker: "Sichuan · 5-6 Days",
    title: "Chengdu, Jiuzhaigou & Huanglong: Pandas & Turquoise Lakes",
    subtitle: "Chengdu's giant pandas, Jiuzhaigou's 114 turquoise lakes, and Huanglong's golden travertine terraces — Sichuan's three icons in one trip.",
    duration: "5-6 days", route: "Chengdu → Jiuzhaigou → Huanglong → Chengdu", budget: "$600-900/person",
    overview: "Sichuan is China's outdoor playground, and this route hits the province's three biggest draws. Chengdu is the panda capital of the world and the spiritual home of Sichuan cuisine. Jiuzhaigou (九寨沟) is a UNESCO-listed valley of 114 turquoise lakes, waterfalls, and snow-capped peaks — arguably China's most beautiful national park. Huanglong (黄龙) is a 3.6 km travertine terrace system of golden calcified pools, nicknamed the 'Yellow Dragon' for the way the pools cascade down the valley.",
    faqQ: "How do I get to Jiuzhaigou from Chengdu?", faqA: "Fly from Chengdu to Jiuzhaigou Huanglong Airport (JZH) — 1 hour, ¥500-900. Alternatively, take a 7-9 hour bus from Chengdu Chadianzi Station (¥150). Flying is strongly recommended. The airport is at 3,400m and you descend to Jiuzhaigou at 2,000-3,000m.",
    stops: [
  ...
  },
  {
    ...
    metaDesc: "A deep dive into Chengdu: pandas, Sichuan cuisine, tea houses, Jinli Street, and the Leshan Giant Buddha day trip — China's most laid-back city.",
    kicker: "Sichuan · 3-4 Days",
    title: "Chengdu In Depth: Pandas, Hot Pot & Tea Houses",
    subtitle: "China's most laid-back city — spend your mornings with pandas, afternoons in 100-year-old tea houses, and evenings sweating through Sichuan hot pot.",
    duration: "3-4 days", route: "Chengdu city + Leshan day trip option", budget: "$300-500/person",
    overview: "Chengdu is the city Chinese people dream of retiring to. The pace is slower, the food is bolder, and the tea house culture — old men playing mahjong in bamboo groves — is still alive. This guide goes deep on the city itself, with optional day trips to Leshan and the Dujiangyan irrigation system.",
    faqQ: "Is 3 days enough for Chengdu?", faqA: "3 days covers the essentials: pandas, Sichuan food, a tea house, and one day trip (Leshan or Dujiangyan). 4 days lets you add a cooking class and explore the Jinli/Wuhouci area more deeply. Chengdu rewards slow travel — you can easily spend a week just eating.",
    stops: [
  ...
  },
  {
    ...
    metaDesc: "Journey from Chengdu to Daocheng Yading Nature Reserve — three sacred snow mountains, turquoise lakes, and Tibetan plateau scenery on a 7-8 day Sichuan adventure.",
    kicker: "Sichuan · 7-8 Days",
    title: "Daocheng Yading: The Last Shangri-La",
    subtitle: "Three sacred snow mountains at 6,000m, turquoise glacier lakes, and Tibetan plateau grasslands — Sichuan's wildest landscape, 800 km west of Chengdu.",
    duration: "7-8 days", route: "Chengdu → Kangding → Litang → Daocheng → Yading → Chengdu", budget: "$800-1,200/person",
    overview: "Daocheng Yading (稻城亚丁) is what happens when you cross the Tibetan Plateau with Yosemite. Three sacred peaks — Chenrezig (6,032m), Jampelyang (5,958m), and Chanadorje (5,958m) — ring a valley of glacier-fed lakes so blue they look Photoshopped. The route from Chengdu climbs from 500m to 4,700m over the Tibetan Plateau, passing through Kangding (the gateway to Tibetan Sichuan), Xinduqiao (the 'photographer's paradise'), and Litang (a 4,000m grassland town that's the birthplace of the 7th Dalai Lama).",
    faqQ: "How difficult is the Yading hike?", faqA: "The main hike to Milk Lake (4,600m) and Five-Color Lake (4,700m) is a 10 km round trip from Luorong Pasture (4,180m). It gains 500m elevation and takes 6-8 hours. The altitude makes it challenging — the air has 60% of sea-level oxygen. You don't need technical skills, but you need to be fit and acclimatised. Horses are available for the first 3 km (¥300 one-way).",
    stops: [
  ...
  },
  {
    ...
    metaDesc: "Chongqing's mountain city skyline, Wulong's natural sinkholes, and Dazu's 1,000-year-old Buddhist rock carvings — a 3-4 day route through eastern Sichuan.",
    kicker: "Chongqing · 3-4 Days",
    title: "Chongqing, Wulong & Dazu Rock Carvings",
    subtitle: "China's most cyberpunk city, a natural limestone bridge formation that looks like Pandora, and 50,000 Buddhist statues carved into cliffs.",
    duration: "3-4 days", route: "Chongqing → Wulong → Dazu → Chongqing", budget: "$350-550/person",
    overview: "Chongqing is China's most dramatic city — built on steep hills at the confluence of the Yangtze and Jialing rivers, with a skyline that rivals Hong Kong and a metro line that runs through a residential building. Wulong's Three Natural Bridges are colossal limestone arches featured in Transformers 4. Dazu Rock Carvings are 50,000 Buddhist, Daoist, and Confucian statues carved between the 7th and 13th centuries — less famous than Dunhuang but arguably more impressive in scale and preservation.",
    faqQ: "Is Chongqing worth visiting?", faqA: "Absolutely. Chongqing is one of China's most visually spectacular cities — the skyline, the river confluence, the hot pot, and the sheer verticality make it unlike anywhere else. It's also the launching point for Yangtze River cruises and a major food destination (Chongqing hot pot is the fieriest in China).",
    stops: [
